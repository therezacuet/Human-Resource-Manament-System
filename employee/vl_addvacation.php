										...
										<div class="col-md-4 col-md-offset-4">
											<div class="alert alert-danger">
												<button type="button" class="close" data-dismiss="alert" aria-hidden="true">
													×</button>
											   <span class="glyphicon glyphicon-remove"></span> <strong>Notice</strong>
												<hr class="message-inner-separator">
												<p><strong> No Days Credits!</strong> Confirm HR.
												</p>
											</div>
										</div>
									</div>
										...
										<div class="col-md-4 col-md-offset-4">
											<div class="alert alert-success">
											   ...
											   <span class="glyphicon glyphicon-ok"></span> <strong>Done!</strong>
												...
												<a href="vl_leave_track.php"><button type="button" class="btn btn-success">Continue</button></a>
												</p>
											</div>
										</div>
									</div>
...
?>
			<div class="row">
				<div class="col-md-6 col-md-offset-4">
					<h1 style = "margin-left:80px">Vacation Leave Form</h1>
				</div>
			</div>
			<br/>
