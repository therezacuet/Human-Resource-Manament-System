									...
									<div class="col-md-4 col-md-offset-4">
										<div class="alert alert-success">
										   ...
										   <span class="glyphicon glyphicon-ok"></span> <strong>Done!</strong>
											...
											<a href="leave_track.php"><button type="button" class="btn btn-success">Continue</button></a>
											</p>
										</div>
									</div>
								</div>
...
?>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-4">
					<h1 style = "margin-left:80px">Sick Leave Form</h1>
				</div>
			</div>
			<br/>
		...
		<div style = "margin-left:-130px">
			...
			<!-- Text input-->
			<div class="form-group">
			  <label class="col-md-6 control-label" for="edate">Effective Date</label>  
			  <div class="col-md-2">
			...
			<!-- Text input-->
			<div class="form-group">
			  <label class="col-md-6 control-label" for="endate">Due Date</label>  
			  <div class="col-md-2">
