  ...
  <div class="container-fluid">
	<?php include("../drop.php");?>
		<?php
			...
			$result=mysql_query("select * from members where username='$UserName' and password='$Password' and id = '6'")or die (mysql_error());//query sang database 
			...
			<div class="col-md-6" style = "margin-top:110px;">
				<div class="panel panel-default">
				   <div class="page-header">
					  <h1 style = "margin-left:50px;">VP Academics <small>Login</small></h1>
					</div>
