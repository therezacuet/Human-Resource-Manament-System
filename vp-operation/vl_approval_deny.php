			...
			<div class="panel-body">
				<div class="table-responsive">
					<?php
						...
						$sql = "SELECT * FROM employee, vacation_log, department, vp_oper
									WHERE employee.emp_id = vacation_log.emp_id AND employee.id_dept = department.id_dept 
									AND vp_oper.vp_operation = vacation_log.vp_operation AND 
									vp_oper.vp_operation = '3'";
						$qry=mysql_query($sql);
					?>
					...
					<tbody>
						<tr>
								...
								<td>
								<a href='vl_approval_deny_approve.php?id=<?php echo $rec['v_id'];?>'><input type='button' value='View' data-toggle="tooltip" data-placement="top" title="View to Approve" class='btn btn-info'/></a>
								</td>
							</tr>
					</tbody>
				<?php
