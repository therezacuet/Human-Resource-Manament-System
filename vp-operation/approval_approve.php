				...
				<div class="table-responsive">
					...
					<tbody>
						<tr>
								...
								<td>
									<a href="leave_view.php?id=<?php echo $rec['leaveid'];?>"><input type='button' value='View' data-toggle="tooltip" data-placement="top" title="View Content" class='btn btn-info'/></a>
								</td>
							</tr>
					</tbody>
				<?php
