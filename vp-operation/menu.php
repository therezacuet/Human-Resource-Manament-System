...
<!--welcome user in menu-->
	<?php
		...
		header('location:login_vp_operation.php');
		}
	?>
<?php
		$id=$_SESSION['id'];
...
?>
					<?php
						...
						$welcome_view = "SELECT * FROM leaves, program_head, vp_oper where leaves.prog_head = program_head.prog_head 
											AND leaves.vp_operation = vp_oper.vp_operation AND program_head.prog_head = '2' AND vp_oper.vp_operation = '1'";
					...
					<?php
						...
						//this will get the data in database		
						$welcome_view = "SELECT * FROM employee, vacation_log, department, program_head, vp_oper
									...
									AND program_head.prog_head = '2' AND vp_oper.vp_operation = '1'";
					...
					<?php
						...
						//this will get the data in database		
						$welcome_view = "SELECT * FROM employee, travel_ordr, vp_academic, vp_oper
									WHERE employee.emp_id = travel_ordr.emp_id AND travel_ordr.vp_acad = vp_academic.vp_acad AND
										travel_ordr.vp_operation = vp_oper.vp_operation AND vp_academic.vp_acad = '2' AND vp_oper.vp_operation = '1'";
